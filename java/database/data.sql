...
('Three Cheese Blend', 'medium', true, 85.00, 5, true, 'All three cheeses. Yes, there are only three.', 'A cheese lover’s dream with a blend of three premium cheeses, melted to perfection.', 'Three Cheese Blend.png');
